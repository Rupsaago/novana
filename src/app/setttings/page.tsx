...
export default function SettingsPage() {
  ...
  return (
    <div className="max-w-xl space-y-5">
      <div>
        <h1 className="font-display text-3xl font-semibold text-nova-text">Settings</h1>
        <p className="text-nova-muted text-sm mt-1">Manage your account and preferences</p>
      </div>

      {/* Profile */}
      <div className="bg-white rounded-3xl border border-nova-border/20
                      shadow-nova-sm p-6 space-y-4">
        <h2 className="font-display text-lg font-semibold text-nova-text">Profile</h2>
        {loading ? (
          ...
          <div className="flex items-center gap-4">
            <div className="w-14 h-14 rounded-2xl bg-nova-gradient flex items-center
                            justify-center text-white font-display text-xl font-semibold">
      ...
      <div className="bg-white rounded-3xl border border-nova-border/20
                      shadow-nova-sm p-5">
        <h2 className="font-display text-lg font-semibold text-nova-text mb-3">About</h2>
        {[
      ...
      <button onClick={handleLogout}
              className="w-full py-3.5 rounded-2xl border border-nova-rose/40
